            ...
            return (()=>{
                var __webpack_modules__ = {
                    "./src/manifest.json" (module) {
                        "use strict";
                        module.exports = JSON.parse('{"package":"com.boxorvoid.demo","name":"箱即是空","versionName":"1.1.0","versionCode":1,"icon":"/common/image/icons/white-box.png","features":[{"name":"system.prompt"},{"name":"system.router"},{"name":"system.device"}],"config":{"logLevel":"log","designWidth":"device-width"},"router":{"entry":"pages/levels/level01","pages":{"pages/levels/level01":{"component":"level01"},"pages/win":{"component":"index"}}},"display":{"backgroundColor":"#1a1a1a"},"deviceTypeList":["watch"]}');
                    }
                };
